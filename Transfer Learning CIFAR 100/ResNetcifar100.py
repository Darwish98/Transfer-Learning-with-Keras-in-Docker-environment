...
(training_images, training_labels) , (test_images, test_labels) = tf.keras.datasets.cifar100.load_data()
...
def FeatureExtractor(inputs):
  ...
  FeatureExtractor = tf.keras.applications.resnet.ResNet50(input_shape=(224, 224, 3),
                                               include_top=False,
...
checkpoint = ModelCheckpoint(filepath = 'RNc100SGD.h5',save_best_only = True,verbose=1)
...
plot_acc_loss(result,'RNc100SGD.png')
