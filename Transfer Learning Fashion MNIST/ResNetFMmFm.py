...
training_images=training_images.repeat(3, -1)



test_images=test_images.reshape((10000,28,28,1))
test_images=test_images.repeat(3, -1)
...
checkpoint = ModelCheckpoint(filepath = 'RNmFMSGDadam2.h5',save_best_only = True,verbose=1)
...
plot_acc_loss(result,'RNmFMSGDadam2.png')
